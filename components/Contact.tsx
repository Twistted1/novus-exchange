...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="relative reveal scroll-mt-0 z-10 flex items-center justify-center py-24 pb-32">
      <div className="container mx-auto px-6 max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 neon-card shine-hover">
            ...
            <form action="https://formspree.io/f/xnngvoyw" method="POST" className="space-y-6">
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 neon-card shine-hover">
              ...
              <form action="https://formspree.io/f/mdkwzpjv" method="POST" className="flex flex-col gap-4">
            ...
            {/* Social Icons - Compact Card */}
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 neon-card shine-hover flex flex-col items-center justify-center">
              <h3 className="text-xl font-bold mb-6 text-white text-center">Follow Us</h3>
              <div className="flex items-center justify-center gap-6 flex-wrap">
                ...
                <a href="https://x.com/novusexchange" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 hover:scale-110 transition-all duration-300" aria-label="X (Twitter)">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H4.68l4.71 6.23L13.89 2.25h4.354zm-1.491 17.25h2.336L7.015 4.022H4.58l12.173 15.478z" /></svg>
                </a>
